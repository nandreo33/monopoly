...
void player::choose_property(Property* property,unsigned int num, player n1){
 if(num >0 && num<= owned_properties.size()){
        trade_properties.push_back(owned_properties[num]);
        n1.remove_property(owned_properties[num]);
        }
  }
